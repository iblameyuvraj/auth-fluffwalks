...
export default function AuthCallbackPage() {
  ...
  // Auto-trigger redirect after 1.5 seconds on success (client-side only for active auth flows)
  useEffect(() => {
  ...
  // Pre-render the full Gateway Informational view during SSR and client hydration.
  // This ensures Google's OAuth review crawlers see the required branding, app features,
  // data disclosure, and exact privacy/terms links without encountering redirects or a blank loading state.
  if (!mounted) {
    return <GatewayInfo />;
  }

  // Hydrated client: direct visit without any auth action parameters.
  if (!isAuthAction) {
    return <GatewayInfo />;
  }
    ...
    <main className="app-container">
      ...
      <div className="auth-wrapper" style={{ maxWidth: "520px" }}>
        ...
        <div className="links-container">
          <a href="https://www.fluffwalks.in/privacy" target="_blank" rel="noopener noreferrer">Privacy Policy</a>
          <span style={{ color: "var(--color-border)" }}>|</span>
          <a href="https://www.fluffwalks.in/terms" target="_blank" rel="noopener noreferrer">Terms of Service</a>
          <span style={{ color: "var(--color-border)" }}>|</span>
